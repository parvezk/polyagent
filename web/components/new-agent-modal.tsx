    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="border-zinc-700/60 bg-zinc-900 text-zinc-100 sm:max-w-[40rem]">
        ...
        <div className="space-y-4 py-2">
          ...
          {/* Repo (+ branch) */}
          <div className="space-y-1.5">
            <label id="repo-label" htmlFor="repo-input" className="text-xs font-medium text-zinc-400">
          ...
          <div className="space-y-1.5">
            <label htmlFor="task-input" className="text-xs font-medium text-zinc-400">Task</label>
            <Textarea
              id="task-input"
              value={prompt}
