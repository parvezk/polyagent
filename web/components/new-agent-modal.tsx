    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="border-zinc-700/60 bg-zinc-900 text-zinc-100 sm:max-w-[40rem]">
        ...
        <div className="space-y-4 py-2">
          ...
          {/* Repo (+ branch) */}
          <div className="space-y-1.5">
            <label htmlFor="repo" className="text-xs font-medium text-zinc-400">
          ...
          {vendor === "claude" && (
            <div className="space-y-1.5">
              <label htmlFor="model" className="text-xs font-medium text-zinc-400">Model</label>
          ...
          <div className="space-y-1.5">
            <label htmlFor="task" className="text-xs font-medium text-zinc-400">Task</label>
            <Textarea
              id="task"
              value={prompt}
