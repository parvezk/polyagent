          ...
          {sessions.map((s, i) => {
            ...
            return (
              <tr
                ...
                tabIndex={0}
                className={`cursor-pointer border-b border-zinc-900 transition-colors hover:bg-zinc-900/60 focus-visible:bg-zinc-900/60 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-500 ${
                  needsYou
