...
export function StatusBadge({ status }: { status: SessionStatus }) {
  ...
  if (status === "needs_review") {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-md bg-amber-400/15 px-2 py-0.5 font-mono text-xs font-semibold text-amber-300 ring-1 ring-amber-400/40 shadow-[0_0_12px_-2px_rgba(251,191,36,0.55)]">
