...
export function SessionDrawer({
  ...
  // Bolt optimization: Reset state during render phase instead of useEffect to avoid cascading re-renders.
  // Prevents an unnecessary commit cycle when switching sessions.
